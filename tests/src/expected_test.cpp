...
{
  expected<int, std::string> ex(wirelab::unexpected<std::string>("error"));
...
TEST(ExpectedTest, BoolConversion)
{
  ...
  expected<int, std::string> ex_error(wirelab::unexpected<std::string>("error"));
...
TEST(ExpectedTest, Assignment)
{
  ...
  ex = wirelab::unexpected<std::string>("error");
  EXPECT_FALSE(ex.has_value());
  EXPECT_EQ(ex.error(), "error");
}
...
TEST(ExpectedTest, VoidSpecialization)
{
  ...
  expected<void, std::string> ex_error(wirelab::unexpected<std::string>("error"));
